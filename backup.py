...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 11 20:25:30 2018
...
for v in range(val_num+1):
    ...
    for r in range(len(itr)):
        ...
        #query_trans = val_query_data
        #gallery_trans = val_gallery_data
...
val_score = np.mean(val_knn_score, axis = 0)
        
    else:
        optimal_itr = iter[np.argmax[knn_score[0:6]]]
        # PCA
        ...
        # Mahalonobis e_vals,
        print("Starting Mahalonobis")
        maha_sup = mmc.MMC_Supervised(max_iter = optimal_itr, num_constraints = 20)
        print("Starting fitting")
        ...
        # Classification
        print("Starting classification")
        val_knn_score = knn_classifier(rank, query_size, query_trans, query_label, query_cam, gallery_size, gallery_trans, gallery_cam, val_gallery_label)
        #kmeans_score = kmeans_classifier(100, query_size, query_trans, query_label, gallery_size, gallery_trans, gallery_label )
